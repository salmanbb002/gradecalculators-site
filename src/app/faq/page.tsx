  ...
  return (
    <>
      ...
      <main className="inner-page">
        <section className="page-hero"><div className="shell"><Breadcrumbs current="FAQ" /><span className="section-kicker">FREQUENTLY ASKED</span><h1>Grade Calculator FAQ</h1><p>Clear answers about test grades, grade charts, percentage formulas, fractional points, letter-grade scales, bonus credit, and calculator privacy.</p><div className="updated-note">9 common questions · Updated July 16, 2026</div></div></section>
