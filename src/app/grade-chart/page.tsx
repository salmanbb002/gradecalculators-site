      ...
      <main className="inner-page">
        ...
        <section className="content-section"><div className="shell content-grid">
          <article className="article-content">
            <h2>10-question grade chart</h2><p>This example uses whole-point scoring and a standard letter-grade scale. Use the calculator to generate the same chart for any test from 1 to 500 questions.</p>
          ...
          <aside className="related-panel"><span>KEEP LEARNING</span><Link href="/grade-calculator/"><b>Free grade calculator</b><small>Generate a live chart.</small><ArrowRight size={16} /></Link><Link href="/grading-scale/"><b>Grading scale</b><small>Review letter thresholds.</small><ArrowRight size={16} /></Link><Link href="/how-to-calculate-grades/"><b>Grade formula</b><small>Calculate scores manually.</small><ArrowRight size={16} /></Link></aside>
        </div></section>
      </main>
      <SiteFooter />
    </>
